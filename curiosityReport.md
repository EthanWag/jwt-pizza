...
This means containers on this network can be assigned any IP between 172.22.0.0 and 172.22.255.255, which gives Docker a huge amount of flexibility for internal communication.
